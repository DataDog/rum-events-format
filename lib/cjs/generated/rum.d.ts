 ...
 */
export declare type RumEvent = RumActionEvent | RumTransitionEvent | RumErrorEvent | RumLongTaskEvent | RumResourceEvent | RumViewEvent | RumViewUpdateEvent | RumVitalEvent;
/**
 ...
 */
export declare type RumViewEvent = CommonProperties & ViewContainerSchema & StreamSchema & ViewProperties & {
    /**
     * RUM event type
     */
    readonly type: 'view';
 ...
 */
export declare type RumViewUpdateEvent = ViewContainerSchema & StreamSchema & ViewProperties & {
    /**
     * RUM event type
     */
