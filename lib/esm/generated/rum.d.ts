...
export interface RumWebSocket {
    ...
    /**
     * Whether the browser fired the WebSocket 'open' event for this connection
     */
    readonly handshake_succeeded?: boolean;
    /**
    ...
    /**
     * View ID where the connection ended
     */
    readonly end_view_id?: string;
    /**
     * Why the SDK stopped tracking the connection
     */
    readonly tracking_end_reason?: 'close_event' | 'session_end';
    /**
     * Value of CloseEvent.code
     */
    readonly close_code?: number;
    /**
     * Value of CloseEvent.reason
     */
    readonly close_reason?: string;
    /**
     * Value of CloseEvent.wasClean
     */
    ...
    /**
     * Silence duration in milliseconds before the connection closed
     */
    readonly idle_duration_before_close?: number;
    /**
     * Peak WebSocket.bufferedAmount (captured before sending a message) in bytes
     */
    readonly buffered_amount_max?: number;
    /**
     * Negotiated WebSocket sub-protocol from WebSocket.protocol once the connection is open
     */
    readonly protocol?: string;
    /**
     * Duration in milliseconds from WebSocket construction until the connection opened or was rejected
     */
