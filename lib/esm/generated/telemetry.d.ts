 ...
 */
export type TelemetryEvent = TelemetryErrorEvent | TelemetryDebugEvent | TelemetryConfigurationEvent | TelemetryUsageEvent | TelemetryFeatureFlagsLifecycleEvent;
/**
...
export type TelemetryFeatureFlagsLifecycleEvent = CommonTelemetryProperties & {
    ...
    telemetry: {
         ...
         */
        event_type: 'sdk_init_started' | 'configuration_received' | 'provider_ready' | 'provider_error' | 'first_evaluation' | 'init_timeout' | 'init_failed';
        /**
